...
class Config:
    ...
    def load_config_json(self) -> dict:
        ...
        for config_file in version_config_paths:
            base_dir = os.path.dirname(os.path.realpath(__file__))  # Get the absolute path of config.py
            config_path = os.path.join(base_dir, config_file)  # Ensure correct path
            ...
            with open(config_path, "r") as f:  # Indentation fixed
